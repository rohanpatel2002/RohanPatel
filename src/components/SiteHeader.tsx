...
export function SiteHeader() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between rounded-full border border-border bg-card/80 px-4 py-2.5 shadow-sm backdrop-blur-md sm:px-5 sm:py-3">
